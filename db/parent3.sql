...
VALUES ('R', current_timestamp(), current_timestamp(), current_timestamp(), 5, 5, 3);

INSERT INTO active_rewards (reward_status, reward_status_date, createdAt, updatedAt, parentRewardId, childId, parentId)
VALUES ('C', current_timestamp(), current_timestamp(), current_timestamp(), 6, 5, 3);

INSERT INTO active_rewards (reward_status, reward_status_date, createdAt, updatedAt, parentRewardId, childId, parentId)
VALUES ('R', current_timestamp(), current_timestamp(), current_timestamp(), 5, 6, 3);

INSERT INTO active_rewards (reward_status, reward_status_date, createdAt, updatedAt, parentRewardId, childId, parentId)
VALUES ('C', current_timestamp(), current_timestamp(), current_timestamp(), 6, 6, 3);